  ...
  return (
    <Card style={{ padding: 'var(--ds-spacing-8)', margin: 'var(--ds-spacing-8)', maxWidth: '800px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--ds-spacing-4)' }}>
        <div>
          <h3 style={{ marginBottom: 'var(--ds-spacing-2)' }}>{t('monitoring.text.contextSetup')}</h3>
        ...
        <div>
          <h3 style={{ marginBottom: 'var(--ds-spacing-2)' }}>{t('monitoring.text.errorTests')}</h3>
          <div style={{ display: 'flex', gap: 'var(--ds-spacing-2)', flexWrap: 'wrap' }}>
        ...
        <div style={{
          ...
          <ol style={{ marginLeft: 'var(--ds-spacing-6)', lineHeight: 'var(--ds-font-line-height-body)' }}>
            ...
            <li>{t('monitoring.text.addSomeBreadcrumbsToTestBreadcrumbTracking')}</li>
            <li>{t('monitoring.text.clickAnyErrorButtonToTriggerATestError')}</li>
            <li>{t('monitoring.text.checkTheBrowserConsoleForErrorLogs')}</li>
            <li>{t('monitoring.text.checkYourSentryDashboardForTheErrorReport')}</li>
