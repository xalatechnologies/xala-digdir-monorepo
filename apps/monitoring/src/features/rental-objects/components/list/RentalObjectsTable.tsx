...
import type { RentalObjectQueryFilters } from '../../types';
import { formatDistanceToNow } from 'date-fns';
import { nb } from 'date-fns/locale';

interface RentalObjectsTableProps {
  listings: RentalObject[];
  isLoading: boolean;
  selectedIds: string[];
  onSelectAll: (selected: boolean) => void;
  onSelectOne: (id: string, selected: boolean) => void;
  onSort: (field: RentalObjectQueryFilters['sortBy']) => void;
  sortBy?: RentalObjectQueryFilters['sortBy'];
  sortOrder?: RentalObjectQueryFilters['sortOrder'];
  onRefresh?: () => void;
}
