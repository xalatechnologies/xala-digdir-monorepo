...
/**
 * Hook to fetch database-driven navigation items for Monitoring
 * 
...
export function useNavigation(
  ...
  return useQuery<NavigationResponse>({
    queryKey: ['navigation', 'monitoring'],
    queryFn: () => fetchNavigation('monitoring'),
...
export const navigationQueryKeys = {
  ...
  monitoring: ['navigation', 'monitoring'] as const,
};
