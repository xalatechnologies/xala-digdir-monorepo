...
/**
 * Hook to fetch database-driven navigation items for SaaS Admin
 * 
...
export function useNavigation(
  ...
  return useQuery<NavigationResponse>({
    queryKey: ['navigation', 'saas-admin'],
    queryFn: () => fetchNavigation('saas-admin'),
...
export const navigationQueryKeys = {
  ...
  saasAdmin: ['navigation', 'saas-admin'] as const,
};
