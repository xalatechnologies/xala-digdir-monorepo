...
CREATE INDEX IF NOT EXISTS "seasons_tenant_idx" ON "seasons" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "seasons_status_idx" ON "seasons" USING btree ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "seasons_dates_idx" ON "seasons" USING btree ("start_date","end_date");--> statement-breakpoint
