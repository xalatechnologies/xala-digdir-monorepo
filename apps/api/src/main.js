...
async function bootstrap() {
    ...
    app.post('/webhooks/stripe', async (request, reply) => {
        ...
        const event = request.adapters.payments.constructWebhookEvent(JSON.stringify(request.body), signature);
    ...
    await adapters.scheduler.schedule('cleanup-cache', '0 */6 * * *', // Every 6 hours
    async () => {
