...
export class JwtService {
  ...
  private readonly issuer: string = 'xala-digilist';
   ...
   */
  generateToken(userId: string, tenantId: string, expiresIn: number = 86400): TokenResult {
    if (!userId || !tenantId) {
  ...
  refreshToken(token: string, expiresIn: number = 86400): TokenResult {
    ...
    return this.generateToken(verified.userId, verified.tenantId, expiresIn);
  }
