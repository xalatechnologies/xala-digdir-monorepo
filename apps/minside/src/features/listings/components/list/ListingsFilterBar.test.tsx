...
import * as useListingPermissionsModule from '../../hooks/useListingPermissions';
...
describe('ListingsFilterBar', () => {
  ...
  const defaultFilters: ListingQueryFilters = {
    search: undefined,
    type: undefined,
    status: undefined,
    sortBy: 'updatedAt',
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    vi.spyOn(useListingPermissionsModule, 'useListingPermissions').mockReturnValue({
  ...
  const renderComponent = (props = {}) => {
    return render(
      <BrowserRouter>
        <ListingsFilterBar {...defaultProps} {...props} />
      </BrowserRouter>
    );
  };
