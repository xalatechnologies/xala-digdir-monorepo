...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@xalatechnologies/platform/ui/themes': path.resolve(__dirname, '../../packages/ui/dist/compat/index.js'),
      '@xalatechnologies/platform/ui/pages': path.resolve(__dirname, '../../packages/ui/dist/compat/index.js'),
      '@xalatechnologies/platform/ui/tokens': path.resolve(__dirname, '../../packages/ui/dist/compat/index.js'),
      ...
      '@xalatechnologies/platform/i18n/locales': path.resolve(__dirname, '../../../xala-platform/packages/platform/dist/i18n/index.js'),
      ...
      '@xalatechnologies/platform/sdk/saas': path.resolve(__dirname, '../../packages/client-sdk/dist/index.mjs'),
      '@xalatechnologies/platform/sdk/http': path.resolve(__dirname, '../../packages/client-sdk/dist/index.mjs'),
      '@xalatechnologies/platform/sdk/errors': path.resolve(__dirname, '../../packages/client-sdk/dist/index.mjs'),
      '@xalatechnologies/platform/sdk/query': path.resolve(__dirname, '../../packages/client-sdk/dist/index.mjs'),
      '@xalatechnologies/platform/sdk/retry': path.resolve(__dirname, '../../packages/client-sdk/dist/index.mjs'),
      '@xalatechnologies/platform/sdk': path.resolve(__dirname, '../../../xala-platform/packages/platform/dist/sdk/index.js'),
      '@xalatechnologies/platform/observability/metrics': path.resolve(__dirname, '../../../xala-platform/packages/platform/dist/index.js'),
      '@xalatechnologies/platform/observability/exporters': path.resolve(__dirname, '../../../xala-platform/packages/platform/dist/index.js'),
      '@xalatechnologies/platform/observability/types': path.resolve(__dirname, '../../../xala-platform/packages/platform/dist/index.js'),
      '@xalatechnologies/platform/observability': path.resolve(__dirname, '../../../xala-platform/packages/platform/dist/index.js'),
