...
export const CATEGORY_OPTIONS = [
  { id: 'all', label: 'Alle kategorier', value: 'all' },
  { id: 'LOKALER_OG_BANER', label: 'Lokaler og baner', value: 'LOKALER_OG_BANER' },
  { id: 'UTSTYR_OG_INVENTAR', label: 'Utstyr og inventar', value: 'UTSTYR_OG_INVENTAR' },
  { id: 'KJORETOY_OG_TRANSPORT', label: 'Kjøretøy og transport', value: 'KJORETOY_OG_TRANSPORT' },
  { id: 'OPPLEVELSER_OG_ARRANGEMENT', label: 'Opplevelser og arrangement', value: 'OPPLEVELSER_OG_ARRANGEMENT' },
];

export const TIME_MODE_OPTIONS = [
  { id: 'all', label: 'Alle bookingtyper', value: 'all' },
...
export const SORT_OPTIONS = [
  { id: 'updated-desc', label: 'Sist oppdatert', value: 'updated-desc', field: 'updatedAt', order: 'desc' },
  { id: 'updated-asc', label: 'Eldste oppdatering', value: 'updated-asc', field: 'updatedAt', order: 'asc' },
  { id: 'name-asc', label: 'Navn (A-Å)', value: 'name-asc', field: 'name', order: 'asc' },
  { id: 'name-desc', label: 'Navn (Å-A)', value: 'name-desc', field: 'name', order: 'desc' },
  { id: 'created-desc', label: 'Nyeste først', value: 'created-desc', field: 'createdAt', order: 'desc' },
  { id: 'created-asc', label: 'Eldste først', value: 'created-asc', field: 'createdAt', order: 'asc' },
];
