...
**Current Migration:** `0031_activity_calendar.sql` (31 migrations total)
...
- Tenants, Organizations, Users, Organization Members
- RBAC (Roles, Permissions, Scopes, Access Grants)
- Subscriptions, Plans, Modules, Entitlements
- Feature Flags, i18n, Themes, Branding
- Audit Events, Outbox Pattern, Notifications
- Webhooks, Secrets Management
- Marketplace (Plugins, Templates, Integrations)

### 2. **domain** - Digilist Business Logic
Domain-specific tables for rental/booking operations:
- **Rental Objects** (formerly "listings") with Categories, Types, Metadata
- **Bookings** with Approvals, Recurring Series, Conflicts Detection
- **Activities/Events** Calendar (NEW: Migration 0031)
- **Favorites** System (NEW: Migration 0030)
- **Permissions** (Granular per-object access control)
- Time Blocks, Seasons, Availability Rules
- Pricing Engine, Payments, Invoices, Transactions
- Amenities, Add-ons, Policies, Discount Codes
- Reviews, Ratings, Feedback
- Integrations, Attachments, Documents
- Case Management, Seasonal Leases
- Geo-location, SEO Metadata

### 3. **saas** - SaaS Administration (NEW: Migration 0029)
Multi-tenant SaaS management:
- Subscription Plans (Free, Starter, Professional, Enterprise)
- Plan Features
- Tenant Subscriptions with Billing Periods
- Licenses (Standard, Trial, Enterprise)
- Feature Flags (Global + Tenant Overrides)

### 4. **monitoring** - Observability
System health and debugging:
- Service Health Checks
- Structured Logs, Alerts, Incidents
- Auth Event Tracing
- Performance Metrics
- Accessibility Monitoring

### 5. **compliance** - GDPR/NSM Safety Layer
