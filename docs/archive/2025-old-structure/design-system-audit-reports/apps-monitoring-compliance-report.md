...
**Generated:** 2026-01-19T11:37:59.372Z
...
- **Line 19**: Hardcoded hex color - `#ffffff`
- **Line 20**: Hardcoded hex color - `#ffffff`

## Major Violations (150)
...
### apps/monitoring/src/components/AccountSelectionModal.tsx
...
### apps/monitoring/src/components/AccountSelector.tsx
...
### apps/monitoring/src/components/AccountSwitcher.tsx
...
### apps/monitoring/src/components/gdpr/ConsentManager.tsx

- **Line 130**: Hardcoded spacing: 44px - `Height: '44px`

### apps/monitoring/src/components/gdpr/DataExportCard.tsx

- **Line 105**: Hardcoded spacing: 44px - `Height: '44px`

### apps/monitoring/src/components/gdpr/DeleteAccountCard.tsx
...
### apps/monitoring/src/features/seasons/components/SeasonCard.tsx
