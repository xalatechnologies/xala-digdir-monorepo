...
**Generated:** 2026-01-19T11:37:59.442Z
...
- **Line 24**: Hardcoded hex color - `#ffffff`
- **Line 25**: Hardcoded hex color - `#ffffff`
...
- **Line 73**: Hardcoded spacing: 599px - `width: 599px`

### apps/web/src/components/SkipLinks.tsx

- **Line 53**: Hardcoded z-index: 10000 - `z-index: 10000`
- **Line 60**: Hardcoded z-index: 10000 - `z-index: 10000`

### apps/web/src/features/rental-object-details/components/BookingDialog.tsx

- **Line 374**: Hardcoded spacing: 36px - `width: '36px`
- **Line 375**: Hardcoded spacing: 36px - `height: '36px`
- **Line 427**: Hardcoded spacing: 28px - `width: '28px`
- **Line 428**: Hardcoded spacing: 28px - `height: '28px`
- **Line 474**: Hardcoded spacing: 28px - `width: '28px`
- ... and 3 more
...
- **Line 713**: Hardcoded spacing: 28px - `width: '28px`
- **Line 714**: Hardcoded spacing: 28px - `height: '28px`
- **Line 819**: Hardcoded spacing: 28px - `width: '28px`
- **Line 820**: Hardcoded spacing: 28px - `height: '28px`
...
- **Line 1238**: Hardcoded spacing: 32px - `width: '32px`
- **Line 1238**: Hardcoded spacing: 32px - `height: '32px`
- **Line 1256**: Hardcoded spacing: 32px - `width: '32px`
- **Line 1256**: Hardcoded spacing: 32px - `height: '32px`
- **Line 1585**: Hardcoded spacing: 56px - `width: '56px`
- ... and 1 more
...
- **Line 583**: Hardcoded spacing: 1024px - `width: 1024px`
