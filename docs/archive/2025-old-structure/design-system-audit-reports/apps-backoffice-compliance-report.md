...
**Generated:** 2026-01-19T11:37:59.270Z
...
### apps/backoffice/src/features/rental-objects/components/wizard/RentalObjectWizard.tsx

- **Line 61**: Hardcoded hex color - `#1E3A52`
- **Line 66**: Hardcoded hex color - `#FFFFFF`
- **Line 78**: Hardcoded hex color - `#1E3A52`
- **Line 102**: Hardcoded hex color - `#4A9EDA`
- **Line 102**: Hardcoded hex color - `#FFFFFF`
- **Line 110**: Hardcoded hex color - `#FFFFFF`
- **Line 115**: Hardcoded hex color - `#FFFFFF`
- **Line 149**: Hardcoded hex color - `#1E3A52`
...
- **Line 109**: Hardcoded spacing: 72px - `height: '72px`
- **Line 121**: Hardcoded spacing: 32px - `height: '32px`
- **Line 171**: Hardcoded spacing: 32px - `width: '32px`
- **Line 172**: Hardcoded spacing: 32px - `height: '32px`
- **Line 268**: Hardcoded spacing: 28px - `height: '28px`
...
- **Line 230**: Hardcoded spacing: 18px - `width: '18px`
- **Line 231**: Hardcoded spacing: 18px - `height: '18px`
- **Line 260**: Hardcoded spacing: 18px - `width: '18px`
- **Line 261**: Hardcoded spacing: 18px - `height: '18px`
- **Line 290**: Hardcoded spacing: 18px - `width: '18px`
- ... and 3 more
...
- **Line 461**: Hardcoded spacing: 18px - `width: '18px`
- **Line 462**: Hardcoded spacing: 18px - `height: '18px`
- **Line 531**: Hardcoded spacing: 18px - `width: '18px`
- **Line 532**: Hardcoded spacing: 18px - `height: '18px`
- **Line 783**: Hardcoded spacing: 48px - `width: '48px`
