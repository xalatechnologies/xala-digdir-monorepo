# Design System Compliance Report: apps/docs-learning

**Generated:** 2026-01-19T11:37:59.282Z
...
### apps/docs-learning/public/themes/digilist-extensions.css
...
### apps/docs-learning/public/themes/digilist.css
...
- **Line 51**: Hardcoded spacing: 768px - `width: 768px`

### apps/docs-learning/src/components/layout/DocsLayout.module.css

- **Line 26**: Hardcoded spacing: 768px - `width: 768px`

### apps/docs-learning/src/routes/DocsArticlePage.module.css

- **Line 101**: Hardcoded spacing: 1024px - `width: 1024px`
