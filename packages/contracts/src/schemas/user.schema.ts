 ...
 * User Schemas
 *
 * Domain-specific contract definitions for users in the Digilist platform.
 * Contains roles and structures specific to the rental booking domain.
 */
import { z } from 'zod';
import {
  UUIDSchema,
...
/**
 * Domain-specific user roles for the Digilist rental booking platform
 */
export const UserRoleSchema = z.enum([
  ...
  'manager',
  'case_handler',
  'saksbehandler', // Norwegian term for case handler
  'member',
  'viewer',
]);
