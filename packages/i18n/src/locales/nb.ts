...
export const nb: Record<string, string> = {
  ...
  'seasons.status.open': 'Åpen for søknader',
  'seasons.status.closed': 'Stengt',
  'seasons.status.active': 'Aktiv',
  'seasons.status.completed': 'Avsluttet',
  'seasons.status.cancelled': 'Kansellert',

  // Application Status
  'seasons.application.pending': 'Til behandling',
  'seasons.application.approved': 'Godkjent',
  'seasons.application.rejected': 'Avslått',
  'seasons.application.cancelled': 'Kansellert',
  'seasons.application.allocated': 'Tildelt',

  // Weekdays
  'seasons.weekday.sunday': 'Søndag',
  'seasons.weekday.monday': 'Mandag',
  'seasons.weekday.tuesday': 'Tirsdag',
  'seasons.weekday.wednesday': 'Onsdag',
  'seasons.weekday.thursday': 'Torsdag',
  'seasons.weekday.friday': 'Fredag',
  'seasons.weekday.saturday': 'Lørdag',

  // Weekdays (short)
  'seasons.weekday.short.sunday': 'Søn',
  'seasons.weekday.short.monday': 'Man',
  'seasons.weekday.short.tuesday': 'Tir',
  'seasons.weekday.short.wednesday': 'Ons',
  'seasons.weekday.short.thursday': 'Tor',
  'seasons.weekday.short.friday': 'Fre',
  'seasons.weekday.short.saturday': 'Lør',

  // Season Card
  'seasons.card.period': 'Periode',
  'seasons.card.applicationDeadline': 'Søknadsfrist',
  'seasons.card.applications': 'Søknader',
  'seasons.card.applicationsTotal': '{{count}} totalt',
  'seasons.card.applicationsApproved': '{{count}} godkjent',
  'seasons.card.viewDetails': 'Se detaljer',
  'seasons.card.applyNow': 'Søk nå',

  // Application Card
  'seasons.applicationCard.season': 'Sesong',
  'seasons.applicationCard.applicationSent': 'Søknad sendt {{date}}',
  'seasons.applicationCard.venue': 'Lokale',
  'seasons.applicationCard.unknownVenue': 'Ukjent lokale',
  'seasons.applicationCard.dayAndTime': 'Dag og tid',
  'seasons.applicationCard.seasonPeriod': 'Sesongperiode',
  'seasons.applicationCard.note': 'Merknad',
  'seasons.applicationCard.rejectionReason': 'Årsak til avslag',
  'seasons.applicationCard.viewSeason': 'Se sesong',
  'seasons.applicationCard.viewVenue': 'Se lokale',

  // Application Drawer
  'seasons.drawer.title': 'Søk om sesongbooking',
  'seasons.drawer.closeLabel': 'Lukk søknadsskjema',
  'seasons.drawer.applyingOnBehalfOf': 'Søker på vegne av: {{org}}',
  'seasons.drawer.applicationAsOrganization': 'Søknaden sendes inn som organisasjon',
  'seasons.drawer.selectVenue': 'Velg lokale *',
  'seasons.drawer.selectVenuePlaceholder': 'Velg et lokale',
  'seasons.drawer.selectVenueHelp': 'Velg hvilket lokale du ønsker å booke',
  'seasons.drawer.selectWeekday': 'Ukedag *',
  'seasons.drawer.selectWeekdayHelp': 'Hvilken ukedag ønsker du faste tider?',
  'seasons.drawer.startTime': 'Fra kl. *',
  'seasons.drawer.endTime': 'Til kl. *',
  'seasons.drawer.notes': 'Merknad (valgfritt)',
  'seasons.drawer.notesPlaceholder': 'Legg til eventuelle merknader eller spesielle behov...',
  'seasons.drawer.notesHelp': 'Del informasjon som kan være viktig for behandling av søknaden',
  'seasons.drawer.submit': 'Send søknad',
  'seasons.drawer.submitting': 'Sender...',
  'seasons.drawer.cancel': 'Avbryt',

  // Application Drawer Errors
  'seasons.drawer.error.selectVenue': 'Vennligst velg et lokale',
  'seasons.drawer.error.selectTime': 'Vennligst velg start- og sluttid',
  'seasons.drawer.error.invalidTime': 'Starttid må være før sluttid',
  'seasons.drawer.error.generic': 'Noe gikk galt. Vennligst prøv igjen.',

  // Venue Card
  'seasons.venue.persons': '{{count}} personer',
  'seasons.venue.area': '{{size}} m²',
  'seasons.venue.applyForThis': 'Søk om denne',
  ...
  // Components - Header
  'components.header.searchPlaceholder': 'Søk i bookinger, brukere...',
  'components.header.noResults': 'Ingen resultater funnet',
  'components.header.notifications': 'Varsler',
  'components.header.notificationsWithCount': 'Varsler ({{count}} uleste)',
  'components.header.settings': 'Innstillinger',
  'components.header.logout': 'Logg ut',
  'components.header.dashboard': 'Dashboard',
  'components.header.goToOverview': 'Gå til oversikt',
  'components.header.bookings': 'Bookinger',
  'components.header.seeAllBookings': 'Se alle dine bookinger',
  'components.header.calendar': 'Kalender',
  'components.header.calendarView': 'Se bookinger i kalendervisning',
  'components.header.messages': 'Meldinger',
  'components.header.conversationsAndMessages': 'Se samtaler og meldinger',
  'components.header.pages': 'Sider',

  // Components - Sidebar
  'components.sidebar.appName': 'DIGILIST',
  'components.sidebar.appSubtitle': 'Min Side',
  'components.sidebar.openMenu': 'Åpne meny',

  // Components - Account Selection Modal
  'components.accountModal.title': 'Hvordan vil du fortsette?',
  'components.accountModal.subtitle': 'Velg om du vil bruke tjenesten som privatperson eller på vegne av en organisasjon',
  'components.accountModal.selectOrganization': 'Velg organisasjon',
  'components.accountModal.selectOrganizationSubtitle': 'Velg hvilken organisasjon du representerer',
  'components.accountModal.personalAccount': 'Som privatperson',
  'components.accountModal.personalAccountDesc': 'Book og administrer egne aktiviteter',
  'components.accountModal.organizationAccount': 'På vegne av organisasjon',
  'components.accountModal.organizationAccountDesc': 'Representér en organisasjon du er tilknyttet',
  'components.accountModal.noOrganizations': 'Du er ikke tilknyttet noen organisasjoner ennå.',
  'components.accountModal.orgNumber': 'Org.nr',
  'components.accountModal.rememberChoice': 'Husk mitt valg',
  'components.accountModal.back': 'Tilbake',
  'components.accountModal.continue': 'Fortsett',

  // Components - Calendar Section
  'components.calendar.notAvailable': 'Kalender er ikke tilgjengelig for dette lokalet.',
  'components.calendar.selectTime': 'Velg tidspunkt',
  'components.calendar.selectTimeSlots': 'Velg ledige tidspunkter',
  'components.calendar.selectDays': 'Velg ledige dager',
  'components.calendar.selectPeriod': 'Velg periode',
  'components.calendar.couldNotLoadSettings': 'Kunne ikke laste kalenderinnstillinger. Vennligst prøv igjen.',
  'components.calendar.couldNotLoadAvailability': 'Kunne ikke laste tilgjengelighet. Vennligst prøv igjen.',
  'components.calendar.selectionChanged': 'Din valgte tid kan ha blitt endret. Vennligst kontroller at valget ditt fortsatt er tilgjengelig.',
  'components.calendar.statusAvailable': 'Ledig',
  'components.calendar.statusReserved': 'Reservert',
  'components.calendar.statusBooked': 'Booket',
  'components.calendar.statusBlocked': 'Blokkert',
  'components.calendar.statusBlackout': 'Utilgjengelig',
  'components.calendar.statusClosed': 'Stengt',

  // Components - Account Switcher
  'components.accountSwitcher.personal': 'Som privatperson',
  ...
  'components.error.title': 'Noe gikk galt',
  'components.error.description': 'En uventet feil har oppstått. Vennligst prøv igjen.',
  'components.error.retry': 'Last siden på nytt',

  // Components - Protected Route
  'components.protected.loading': 'Laster...',
  'components.protected.noAccess': 'Ingen tilgang',
  'components.protected.noAccessDescription': 'Du har ikke tilgang til denne siden.',
  'components.protected.contactAdmin': 'Kontakt administrator hvis du mener dette er feil.',
  ...
  'common.hoursAgo': '{{count}} timer siden',
  'common.daysAgo': '{{count}} dager siden',
  ...
  'org.backToDashboard': 'Tilbake til dashboard',
  'org.totalMembers': 'Totalt medlemmer',
  'org.admins': 'Administratorer',
  'org.regularMembers': 'Vanlige medlemmer',
  'org.allMembers': 'Alle medlemmer',
  'org.noMembers': 'Ingen medlemmer',
  'org.inviteMember': 'Inviter medlem',
  'org.inviteNewMember': 'Inviter nytt medlem',
  'org.removeMember': 'Fjern medlem',
  'org.confirmRemoveMember': 'Er du sikker på at du vil fjerne {{name}} fra organisasjonen?',
  'org.activeBookings': 'Aktive bookinger',
  'org.outstanding': 'Utestående',
  'org.quickActions': 'Hurtigvalg',
  'org.viewBookings': 'Se bookinger',
  'org.viewInvoices': 'Se fakturaer',
  'org.manageMembers': 'Administrer medlemmer',
  'org.organizationProfile': 'Organisasjonsprofil',
  'org.orgNumber': 'Org.nr',
  'org.address': 'Adresse',
  'org.postalCode': 'Postnr',
  'org.city': 'Sted',
  'org.billing': 'Fakturering',
  'org.invoiceEmail': 'Faktura e-post',
  'org.paymentTerms': 'Betalingsfrist (dager)',
  'org.bookedBy': 'Booket av',
  'org.noBookings': 'Ingen bookinger',
  'org.noInvoices': 'Ingen fakturaer',
  'org.noOrganizationSelected': 'Ingen organisasjon valgt',
  'org.noOrganizationSelectedDesc': 'Velg en organisasjon for å konfigurere varslingsinnstillinger.',

  // Organization - Season Rental
  'org.seasonRental.apply': 'Søk om sesongleie',
  'org.seasonRental.applyDesc': 'Søk om faste tider for din organisasjon',
  'org.seasonRental.steps.season': 'Sesong',
  'org.seasonRental.steps.slots': 'Ønsket tid',
  'org.seasonRental.steps.details': 'Detaljer',
  'org.seasonRental.steps.review': 'Send',
  'org.seasonRental.selectSeason': 'Velg sesong',
  'org.seasonRental.open': 'Åpen',
  'org.seasonRental.upcoming': 'Kommer',
  'org.seasonRental.desiredTimes': 'Ønskede tider',
  'org.seasonRental.addTime': '+ Legg til tid',
  'org.seasonRental.addTimeHint': 'Klikk "Legg til tid" for å legge til ønskede tidsluker',
  'org.seasonRental.contactInfo': 'Kontaktinformasjon',
  'org.seasonRental.contactPerson': 'Kontaktperson',
  'org.seasonRental.contactPersonPlaceholder': 'Ola Nordmann',
  'org.seasonRental.phonePlaceholder': '12345678',
  'org.seasonRental.applicationNote': 'Merknad til søknaden',
  'org.seasonRental.applicationNotePlaceholder': 'Beskriv behovet deres...',
  'org.seasonRental.summary': 'Oppsummering',
  'org.seasonRental.season': 'Sesong',
  'org.seasonRental.numberOfTimes': 'Antall tider',
  'org.seasonRental.contact': 'Kontakt',
  'org.seasonRental.note': 'Merknad',
  'org.seasonRental.sending': 'Sender...',
  'org.seasonRental.sendApplication': 'Send søknad',
  'org.seasonRental.applicationSent': 'Søknad sendt!',

  // Organization - Activity
  'org.activity.allTypes': 'Alle typer',
  'org.activity.bookings': 'Bookinger',
  'org.activity.members': 'Medlemmer',
  'org.activity.invoices': 'Fakturaer',
  'org.activity.season': 'Sesong',
  'org.activity.today': 'I dag',
  'org.activity.thisWeek': 'Denne uken',
  'org.activity.noActivity': 'Ingen aktivitet å vise',
  'org.activity.typeBooking': 'Booking',
  'org.activity.typeMember': 'Medlem',
  'org.activity.typeInvoice': 'Faktura',
  'org.activity.typeSeason': 'Sesong',

  // Organization - Notification Settings
  'org.notificationSettings.bookingConfirmations': 'Bookingbekreftelser',
  'org.notificationSettings.bookingConfirmationsDesc': 'Motta bekreftelse ved nye bookinger',
  'org.notificationSettings.reminders': 'Påminnelser',
  'org.notificationSettings.remindersDesc': 'Motta påminnelse før bookinger',
  'org.notificationSettings.invoices': 'Fakturaer',
  'org.notificationSettings.invoicesDesc': 'Motta fakturaer på e-post',
  'org.notificationSettings.smsReminders': 'SMS-påminnelser',
  'org.notificationSettings.smsRemindersDesc': 'Motta påminnelser via SMS',
  'org.notificationSettings.resetToDefault': 'Tilbakestill til standard',
  'org.notificationSettings.loadError': 'Kunne ikke laste innstillinger',
  'org.notificationSettings.loadErrorDesc': 'En feil oppstod ved lasting av varslingsinnstillinger.',
  'org.notificationSettings.saveError': 'Kunne ikke lagre innstillinger',
  'org.notificationSettings.settingsSaved': 'Innstillinger lagret',
};
