...
export const en: Record<string, string> = {
  ...
  'auth.demoLoginDescription': 'Test environment for development',
  'auth.demoForm.title': 'Demo Login',
  'auth.demoForm.description': 'Fill in the information below to log in to demo mode.',
  'auth.demoForm.name': 'Name',
  'auth.demoForm.email': 'Email',
  'auth.demoForm.token': 'Demo Token',
  'auth.demoForm.namePlaceholder': 'Your name',
  'auth.demoForm.emailPlaceholder': 'your.email@example.com',
  'auth.demoForm.tokenPlaceholder': 'Enter demo token',
  'auth.demoForm.nameRequired': 'Name is required',
  'auth.demoForm.emailRequired': 'Email is required',
  'auth.demoForm.tokenRequired': 'Demo token is required',
  'auth.demoForm.invalidEmail': 'Invalid email address',
