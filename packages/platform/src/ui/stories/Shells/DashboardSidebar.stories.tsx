...
import { DashboardSidebar, type SidebarSection } from '@xalatechnologies/platform/ui';
import { HomeIcon, CalendarIcon, SettingsIcon, UserIcon, BellIcon, InboxIcon, ChartIcon, BuildingIcon } from '@xalatechnologies/platform/ui';
