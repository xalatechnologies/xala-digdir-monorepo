 ...
 *
 * Platform-agnostic entitlements and subscription management for any SaaS application.
 */
...
export type NavPolicy = typeof navPolicies.$inferSelect;
export type NewNavPolicy = typeof navPolicies.$inferInsert;
export type GlobalKillSwitch = typeof globalKillSwitches.$inferSelect;
export type NewGlobalKillSwitch = typeof globalKillSwitches.$inferInsert;
export type EntitlementAuditLog = typeof entitlementAuditLog.$inferSelect;
export type NewEntitlementAuditLog = typeof entitlementAuditLog.$inferInsert;
