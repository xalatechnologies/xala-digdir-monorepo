 ...
 *
 * Platform-agnostic translation management for any SaaS application.
 */
import {
  uuid,
  varchar,
 ...
 * Domains can extend this with their own namespaces
 */
export const DEFAULT_TRANSLATION_NAMESPACES = [
  'common',
  'auth',
  'nav',
  'settings',
...
export type DefaultTranslationNamespace = typeof DEFAULT_TRANSLATION_NAMESPACES[number];

/**
 * Supported languages (default set)
 * Domains can extend this with additional languages
 */
export const DEFAULT_SUPPORTED_LANGUAGES = ['en'] as const;
