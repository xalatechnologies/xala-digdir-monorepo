 ...
 * Icon Components
 *
 * SVG icons for platform-compat compatibility layer.
 * Using Lucide-style icons with consistent 24x24 viewBox.
 */
...
const iconStyle = (size: number | string = 24) => ({
  width: size,
  height: size,
...
export function HomeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} style={iconStyle(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function ClipboardListIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} style={iconStyle(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function TableIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} style={iconStyle(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
// Export aliases
export { ChevronDownIcon as DropdownIcon };
export { BarChartIcon as BarChart };
