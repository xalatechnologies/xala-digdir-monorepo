 ...
 * KeyFactsRow
 *
 * Displays key rental object facts as a horizontal row of badges/chips.
 * Adapts based on rental object type to show relevant information.
 */
...
export interface KeyFact {
  ...
  label: string;
  /** Display value (e.g., "25 personer", "120 m2") */
  value: string;
