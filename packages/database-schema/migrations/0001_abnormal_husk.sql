...
CREATE TABLE "compliance"."gdpr_requests" (
	...
	"requester_national_id" varchar(11),
	"description" text,
...
ALTER TABLE "compliance"."gdpr_requests" ADD CONSTRAINT "gdpr_requests_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "platform"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "compliance"."gdpr_requests" ADD CONSTRAINT "gdpr_requests_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "platform"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "compliance"."gdpr_requests" ADD CONSTRAINT "gdpr_requests_assigned_to_users_id_fk" FOREIGN KEY ("assigned_to") REFERENCES "platform"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
