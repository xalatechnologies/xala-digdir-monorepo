 ...
 *
 * Domain-specific contract definitions for the capabilities system.
 * Contains capabilities specific to the Digilist rental booking platform.
 */
import { z } from 'zod';
 ...
 * Includes domain-specific actions like 'book' and 'rebook'.
 */
export const ActionCodeSchema = z.enum([
  ...
  'duplicate',
  'export',
  // Domain-specific actions (rental/booking)
  'book',
  'modify',
  'rebook',
]);
...
/**
 * UI hints for showing/hiding domain-specific sections.
 */
export const UIHintsSchema = z.object({
  ...
  showSeasons: z.boolean().optional(), // Digilist-specific
});
...
// =============================================================================
// Capability Constants - Domain-Specific
// =============================================================================

/**
 * All capabilities for the Digilist rental booking platform.
 * These are domain-specific and include rental object, booking, and organization capabilities.
 */
