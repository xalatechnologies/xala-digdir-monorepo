...
describe('Extras API', () => {
  ...
  describe('GET /api/extras', () => {
    it('should return extras list', async () => {
  ...
  describe('POST /api/extras', () => {
    it('should create extra', async () => {
      const response = await fetch(`${API_URL}/api/extras`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ name: 'Parking', price: 25 }),
      });
  ...
  describe('PUT /api/extras/:id', () => {
    it('should update extra', async () => {
      const response = await fetch(`${API_URL}/api/extras/00000000-0000-0000-0000-000000000000`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
