...
import { RealtimeProvider, useRealtimeStatus } from '@digilist/api/../packages/client-sdk/src/providers/RealtimeProvider';
...
} from '@digilist/api/../packages/client-sdk/src/hooks';
...
// SKIPPED
describe.skip('RealtimeProvider', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
