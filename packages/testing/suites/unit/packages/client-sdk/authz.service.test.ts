...
import { AuthzService, authzService } from '@digilist/api/services/authz.service';
import type { AuthzResource, AuthzAction } from '@digilist/api/services/authz.service';
